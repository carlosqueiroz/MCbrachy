...
class TestExtractPositioningFromRtDose(unittest.TestCase):
    def test_ldr_rt_dose(self):
        ...
        self.assertEqual(x_y_z_spacing, (1.02631578947368, 1.025963, 0.96749246428571))
...
class TestExtractDosimetry(unittest.TestCase):
    def test_no_dvh(self):
        ...
        self.assertEqual(dosi.pixel_spacing, (1.02631578947368, 1.025963, 0.96749246428571))
    ...
    def test_with_dvh(self):
        ...
        self.assertEqual(dosi.pixel_spacing, (-1.0, 2.5, 2.5))
