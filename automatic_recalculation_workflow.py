...
if __name__ == "__main__":
    ...
    simulation_runner = SimulationRunners(nb_treads=4, waiting_time=20,
                                          egs_brachy_home=r'/EGSnrc_CLRP/egs_home/egs_brachy')

    output_cleaner = OutputCleaners(
        software="Systematic MC recalculation Workflow V0.3: commit: 6e8b9c22f0b5bc2874903f2c56862e174b3ca442",
        dose_summation_type="PLAN",
        patient_orientation="",
        bits_allocated=16,
        series_description="Workflow_benchmarking_tg186_validation_article_2023_line_source_TG43_V3",
        generate_dvh=True,
        generate_sr=generate_sr,
